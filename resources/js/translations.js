...
export default {
    ...
    methods: {
        ...
        /**
         * Searches for :placeholder in a string and replaces it with replacement value.
         *
         * @param message
         * @param replacements
         * @returns String
        ...
        replacePlaceholders(message, replacements) {
            Object.keys(replacements).forEach((item) => {
                message = message.replace(':' + item, replacements[item]);
            });
            return message;
        },
        /**
         * Choose proper plural form.
         *
         * @param locale
         * @param $number
         * @returns {number}
         */
        pluralIndex(locale, $number) {
            switch (locale) {
                case 'az':
                case 'az_AZ':
                case 'bo':
